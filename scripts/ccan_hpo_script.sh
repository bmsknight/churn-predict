...
#SBATCH --array 1-100%3   # This will launch N jobs, but only allow M to run in parallel
...
OPTUNA_STUDY_NAME=hyper_search_churn_nn_study1
...
python scripts/neural-network-hpo-script.py --optuna-db $OPTUNA_DB --optuna-study-name $OPTUNA_STUDY_NAME
